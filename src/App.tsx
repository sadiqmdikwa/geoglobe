    ...
    >
      ...
      >
        ...
        <motion.div 
          ...
          onClick={() => navigate("/videos")}
          className="relative bg-gray-900/40 backdrop-blur-xl rounded-[2rem] p-8 border border-white/5 hover:border-geoCyan/40 transition-all group cursor-pointer overflow-hidden shadow-xl"
        >
          <div className="bg-geoCyan/10 w-14 h-14 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-geoCyan group-hover:text-black transition-all duration-300">
            <PlayCircle className="text-geoCyan w-7 h-7 group-hover:text-black transition-colors" />
          </div>
          <h3 className="text-white text-2xl font-black mb-3 italic uppercase tracking-tighter group-hover:text-geoCyan transition-colors">Video Library</h3>
        ...
        >
          ...
          <h3 className="text-white text-2xl font-black mb-3 italic uppercase tracking-tighter group-hover:text-geoCyan transition-colors">Interactive Map</h3>
          <p className="text-gray-500 text-sm leading-relaxed mb-6 font-medium">
        ...
        >
          ...
          <h3 className="text-white text-2xl font-black mb-3 italic uppercase tracking-tighter group-hover:text-geoCyan transition-colors">Geo Game</h3>
          <p className="text-gray-500 text-sm leading-relaxed mb-6 font-medium">
...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-geoDark">
      ...
      {/* Footer */}
      <footer className="bg-black/40 backdrop-blur-md py-16 px-4 md:px-8 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col items-center space-y-10">
          <div className="flex flex-col items-center space-y-4 cursor-pointer group" onClick={() => navigate("/")}>
            <img 
              src="https://lh3.googleusercontent.com/d/1PYQ705DpgwDPAV7kERrpa8a0m8hFdq5w" 
              alt="GeoGlobe" 
              className="h-20 w-20 object-contain group-hover:scale-110 transition-transform" 
            />
            <span className="geoglobe-text text-geoCyan font-black text-3xl uppercase italic tracking-tighter">GeoGlobe</span>
          </div>
          ...
          <div className="flex justify-center gap-10">
            ...
            <a href="https://www.instagram.com/geoglobe23" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-geoCyan transition-all hover:-translate-y-1">
              <svg className="w-7 h-7 fill-none stroke-current stroke-2" viewBox="0 0 24 24" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
            </a>
          </div>

...
export default function SuggestionForm() {
  ...
  const getCoordinates = async (locationName: string) =import { useState } from 'react';
...
export default function SuggestionForm() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const scriptUrl = 'https://docs.google.com/spreadsheets/d/e/2PACX-1vSN2eegc7Fbv9U2Wlui2p3kzG9mai7Q-lbNF-zHW2mNpOPNESCg5Oiwqvnr8IPIVVqfrfl6CVRkIqnV/pub?output=csv'; 
